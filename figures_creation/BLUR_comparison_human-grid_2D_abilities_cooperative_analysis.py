...
def main():
    ...
    try:
        ...
        blurred_path = output_dir / f'blurred_{base_filename}.png'
        softer_path = output_dir / f'softer_{base_filename}.png'
        ...
        print('\n=== Analysis Complete ===\n')
        print(f'Generated figures: {blurred_path} and {softer_path}')
